...
class Grid:
    ...
    def start(self, numOfTurtle, numOfCoin):
        ...
        locList.append((1, 1))
        #add coin
        self.world[(1, 1)] = coinType

        for y  in range(1, self.height):
            self.world[(0, y)] = 2
            self.world[(self.width-1, y)] = 2
            locList.append((0, y))
            locList.append((self.width-1, y))

        for x in range(0, self.width):
            self.world[(x, 0)] = 2
            self.world[(x, self.height-1)] = 2
            locList.append((x, 0))
            locList.append((x, self.height-1))
